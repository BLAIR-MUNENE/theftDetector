...
export default async function SurveillanceDashboard() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <section>
        <h2 className="mb-4 font-headline text-lg font-semibold tracking-wide text-foreground">Camera feeds</h2>
        <LiveFeeds />
      </section>
    </div>
  );
