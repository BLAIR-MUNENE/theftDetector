...
export default function RoiPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <header><h1 className="font-headline text-2xl font-bold tracking-tight text-foreground sm:text-3xl">Region of interest</h1><p className="mt-1 text-sm text-muted">Click to add polygon vertices (mapped to {W}x{H}). Right-click preview to clear.</p></header>
